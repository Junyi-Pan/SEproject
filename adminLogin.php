...
<head>
	<meta charset="utf-8">
	<title>TT Admin Login</title> <!-- decide on name -->
...
<body class="gradientBody">
	...
	<div class="adminLogForm">
			...
			<h3>Admin Login to Turbo Theatres</h3>
			...
			<div class="formFields">
				...
				<div class="checkField">
					<input class="checkInput" type="checkbox" name="rememberMe" id="rememberMe" value="XX">      <!-- fix value -->
